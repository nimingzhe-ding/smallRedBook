...
window.els = {
  ...
  profileEditAvatarButton: document.querySelector("#profileEditAvatarButton"),
  profileEditAvatarFile: document.querySelector("#profileEditAvatarFile"),
  profileEditIconInput: document.querySelector("#profileEditIconInput"),
  profileEditPreview: document.querySelector("#profileEditPreview"),
  profileEditPreviewName: document.querySelector("#profileEditPreviewName"),
  profileEditPreviewMeta: document.querySelector("#profileEditPreviewMeta"),
  profileEditBioCount: document.querySelector("#profileEditBioCount"),
  profileEditSaveButton: document.querySelector("#profileEditSaveButton"),
