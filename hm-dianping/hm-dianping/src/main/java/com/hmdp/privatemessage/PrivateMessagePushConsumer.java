...
public class PrivateMessagePushConsumer {
    ...
    @KafkaListener(
            topics = "${hmdp.private-message.kafka.topic:private-message}",
            groupId = "${hmdp.private-message.kafka.push-consumer-group:private-message-push-consumer-group}",
    ...
    @KafkaListener(
            topics = "${hmdp.private-message.kafka.dlt-topic:private-message.DLT}",
            groupId = "${hmdp.private-message.kafka.dlt-consumer-group:private-message-dlt-compensation-group}",
            containerFactory = "privateMessageKafkaListenerContainerFactory"
    )
