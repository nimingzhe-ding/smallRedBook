...
public class DanmakuNettyWebSocketServer {
    ...
    public void start() throws InterruptedException {
        if (!properties.isEnabled()) {
            log.info("Danmaku Netty websocket server is disabled");
            return;
        }
        ...
        log.info("Danmaku Netty websocket server started at ws://0.0.0.0:{}{}",
    ...
    public void stop() {
        ...
        log.info("Danmaku Netty websocket server stopped");
    }
}
