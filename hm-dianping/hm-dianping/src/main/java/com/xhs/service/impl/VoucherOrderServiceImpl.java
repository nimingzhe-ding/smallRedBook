...
public class VoucherOrderServiceImpl extends ServiceImpl<VoucherOrderMapper, VoucherOrder>
    ...
    @Value("${xiaohongshu.seckill.kafka.order-topic:seckill-order}")
    ...
    @KafkaListener(
            topics = "${xiaohongshu.seckill.kafka.order-topic:seckill-order}",
            groupId = "${xiaohongshu.seckill.kafka.order-consumer-group:seckill-order-consumer-group}",
    ...
    @KafkaListener(
            topics = "${xiaohongshu.seckill.kafka.order-dlt-topic:seckill-order.DLT}",
