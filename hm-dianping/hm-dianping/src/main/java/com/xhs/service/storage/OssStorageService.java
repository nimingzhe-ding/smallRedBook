...
@Slf4j
@Service
@ConditionalOnProperty(name = "xiaohongshu.storage.type", havingValue = "oss")
public class OssStorageService implements FileStorageService {

    @Value("${xiaohongshu.storage.oss.endpoint:}")
    private String endpoint;

    @Value("${xiaohongshu.storage.oss.bucket:}")
    private String bucket;

    @Value("${xiaohongshu.storage.oss.access-key:}")
    private String accessKey;

    @Value("${xiaohongshu.storage.oss.secret-key:}")
    private String secretKey;

    @Value("${xiaohongshu.storage.oss.domain:}")
